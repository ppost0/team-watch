  ...
  return (
    <header className="flex items-center justify-between p-4x text-white">
      <div className="flex items-center">
        <Image src="/logo.png" alt="Logo" className="h-10 m-4 transition duration-300 hover:filter hover:brightness-125 hover:drop-shadow-lg cursor-pointer" width={40} height={40} />
      </div>
